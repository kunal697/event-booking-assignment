    ...
    const handleProceed = async () => {
      ...
      try {
        ...
        const response = await axios.post('/api/tickets', {
          eventId: id // Using the id from useParams
        });
                        ...
                        <div className='mb-5'>
                                  <Link 
                                    ...
                                    className={`mt-5 p-3 ml-2 w-36 text-gray-100 items-center ${
                                      isCheckboxChecked ? 'bg-blue-700 hover:bg-blue-800' : 'bg-gray-300'
                                    } gap-2 rounded-md ${loading ? 'cursor-not-allowed opacity-70' : ''}`}
